...
public class HelloWorldTestMessageProcessorDebuggable
    extends HelloWorldTestMessageProcessor
    implements DebugInfoProvider
{


    public HelloWorldTestMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("person", "The person", (java.lang.String.class), person, muleEvent));
